...
Set `disable_effects: true` in the app config. See the [configuration docs](https://github.com/fat-fred/govee2mqtt-2fa/blob/main/docs/CONFIG.md#effect-list-filtering) for details.
...
- Repo: https://github.com/fat-fred/govee2mqtt-2fa
- Configuration: https://github.com/fat-fred/govee2mqtt-2fa/blob/main/docs/CONFIG.md
- FAQ: https://github.com/fat-fred/govee2mqtt-2fa/blob/main/docs/FAQ.md
